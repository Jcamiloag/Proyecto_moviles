...
class PasoParametrosScreenState extends State<PasoParametrosScreen> {
  ...
  void goToDetalle(String metodo) {
    ...
    switch (metodo) {
      case 'go':
        context.go('/detalle/$valor/$metodo'); // Navegamos a la pantalla de detalle
        break;
      case 'push': // Agregamos una nueva pantalla a la pila de navegación
        context.push('/detalle/$valor/$metodo'); 
        break;
      case 'replace': // Reemplazamos la pantalla actual
  ...
  Widget build(BuildContext context) {
    return BaseView(
      title: "Parametros", // Título de la pantalla
      initialIndex: 0, // Provide a default or appropriate value
      length: 3, // Provide a default or appropriate value
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: 140.0,
              height: 40.0,
              child: const SizedBox(height: 10), // Espaciado entre elementos
            ),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color.fromARGB(255, 242, 234, 191), // Color primario de la aplicación
              ),
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color.fromARGB(255, 242, 234, 191),
